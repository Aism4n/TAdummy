...
/datum/storyteller/astrata
	...
	desc = "Бандиты, личи, оборотни и вампирские лорды не выпадают. Маскарад - единственный основной антагонист на старте раунда и получает вес x1.5. Гноллы отключены. wretchs масштабируются обычным образом."
...
/datum/storyteller/abyssor
	...
	desc = "Водные события получают вес x1.3, торговые - x1.2. dreamwalker получает вес x1.5 в пуле антагонистов. Гноллы отключены."
...
/datum/storyteller/eora
	name = "Eora"
	ru_name = "Эора"
	vote_desc = "Воцаряется любовь. Добрые события приходят чаще, и Она не желает никому зла. Без антагонистов и гноллов; лишь горстка wretchs прячется на окраинах. Её милость обращена к романтике."
	desc = "Массовые события получают вес x1.5, благословения - x1.2. Без антагонистов и набегов. Божественное вмешательство случается в 2 раза чаще, личные события - в 1.4 раза чаще. wretchs жёстко ограничены 5-ю слотами. Гноллы отключены."
...
/datum/storyteller/baotha
	...
	desc = "События безумия, магии и бедствий получают повышенный вес (от x1.1 до x1.4). Вампирский лорд гарантирован на старте раунда; бандиты, личи и оборотни не выпадают. Все события накапливают очки быстрее. Режим гноллов выбирается случайно. Может сработать расширение количества слотов wretchs в зависимости от количества слотов гарнизона."
