...
/datum/storyteller/gamemode/no_antag/small_wretch
	name = "Low Intensity"
	vote_desc = "Без основных антагонистов. Легких антагонистов меньше."
	desc = "Без основных антагонистов. Отродья фиксированы на 5 слотах. До 1 гнолла. Hag присутствует. Могут появиться dreamwalkers."
	color_theme = "#1f6b67"
	allow_dreamwalker = FALSE
	preferred_gnoll_mode = GNOLL_SCALING_SINGLE	// max 1
	wretch_slot_cap = 5
