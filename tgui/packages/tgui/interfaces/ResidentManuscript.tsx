...
const TEXTS: ResidentManuscriptTexts = {
  ...
  subtitle_prefix: 'Чернилами связанное свидетельство под угасающим законом',
  profiles: {
    resident: {
      display_name: 'Грамота жителя',
      subtitle: 'Под рукой Короны',
      description:
        'Да будет ведомо: под холодным коронным воском и черными чернилами предъявитель числится среди названных душ этих земель. Врата, очаг и виселица должны знать его имя, пока закон или смерть не вычеркнут его из реестра.',
    },
    guards: {
      display_name: 'Гарнизонная грамота',
      subtitle: 'От гарнизона и Короны',
      description:
        'Да будет ведомо: предъявитель стоит солдатом городского гарнизона, присягнув держать врата, стены и улицы, когда обнажается сталь. Его служба проста как железо: ночные дозоры, кровь на камне и жалованье за верность.',
    },
    church: {
      display_name: 'Церковная грамота веры',
      subtitle: 'Под Десятеричным Светом',
      description:
        'Да будет ведомо: предъявитель отмечен под Десятеричным Светом, где милость горит так же остро, как суд. Пусть святилище и алтарь принимают его, пока тень или ересь не взыщут его имя.',
    },
    craftsmen: {
      display_name: 'Хартия ремесленной гильдии',
      subtitle: 'Честной рукой и бронзой',
      description:
        'Да будет ведомо: предъявитель связан с горном, шилом, резцом и клятвой. Его труд может идти под защитой гильдии, а долг ремеслу будет взвешен монетой, потом и кровью.',
    },
    merchant: {
      display_name: 'Хартия торговой лавки',
      subtitle: 'Монетой и клыком',
      description:
        'Да будет ведомо: предъявитель служит счетному дому, где монету взвешивают как грех, а каждая сделка имеет тень. Его торговля законна, его книги подотчетны, а долги памятны.',
    },
    mages: {
      display_name: 'Патент гильдии магов',
      subtitle: 'Светом Короны, звездой и сигилом',
      description:
        'Да будет ведомо: коронным дозволением и гильдейским знаком предъявитель вправе иметь дело со звездой, зельем и призванным шепотом. Пусть никто не препятствует его искусству, пока само искусство не возжаждет сорваться с цепи.',
    },
    commoner: {
      display_name: 'Грамота горожанина',
      subtitle: 'Знаком городского старейшины',
      description:
        'Да будет ведомо: предъявитель есть простая душа города, вписанная дешевыми чернилами на грубой бумаге. Ему дозволено быть среди законного люда без блеска, привилегий и дворянской милости.',
    },
    mercenary: {
      display_name: 'Наемный контракт',
      subtitle: 'Монетой, сталью и словом',
      description:
        'Да будет ведомо: предъявитель есть клинок, проданный при свидетеле и связанный монетой, сталью и словом капитана. Он может проливать кровь по договору и отвечать за нее, когда высохнут чернила.',
    },
    otava: {
  ...
  description:
    'Да будет ведомо: эта грамота связывает имя с законом, воском и свидетельством под темнеющей короной.',
  defects: {
