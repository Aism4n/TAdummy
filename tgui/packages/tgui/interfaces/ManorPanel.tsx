...
const GOD_TOOLTIPS: Record<string, string> = {
  ...
  'matthios': 'Жители вашего имения - не слуги, но товарищи в борьбе за свободу. Они не платят налога ни казне, ни вам, вместо этого добровольно поддерживая вас финансами. Часть сырья и товаров укрывается от казны и продается на рынке.',
  'necra': '',
